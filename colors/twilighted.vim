...
" copied from https://github.com/jeaye/color_coded/blob/master/colors/twilighted.vim
" I might modify this a bit if I want to change the highlighting for c and cpp files
