...
autocmd FileType javascript :let s:comment = "//"
autocmd FileType java :let s:comment = "//"
autocmd FileType python :let s:comment = "#"
autocmd FileType sh :let s:comment = "#"
