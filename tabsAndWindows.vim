...
nnoremap <silent> <leader><Left> <C-w>v:enew<CR>
nnoremap <silent> <leader><Right> <C-w>v:wincmd l<CR>:enew<CR>
nnoremap <silent> <leader><Up> <C-w>s:enew<CR>
nnoremap <silent> <leader><Down> <C-w>s:wincmd j<CR>:enew<CR>
